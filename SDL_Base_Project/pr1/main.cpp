...
int main(int argc, char* argv[])
{
    ...
    SDL_Surface* surface1= IMG_Load("/Users/karen/Documents/Igboabuchukwu-chinaza-computer-graphics/SDL_Base_Project/pr1/good.jpg");
    SDL_Texture* texture1 = SDL_CreateTextureFromSurface(renderer, surface1);
    SDL_FRect imgrect1= { 500,300,200,200 };
         SDL_DestroySurface(surface1);


    SDL_Surface* surface2 = IMG_Load("/Users/karen/Documents/Igboabuchukwu-chinaza-computer-graphics/SDL_Base_Project/pr1/shadow.jpg");
    SDL_Texture* texture2 = SDL_CreateTextureFromSurface(renderer, surface2);
    SDL_FRect imgrect2 = { 300,50,200,200 };
         SDL_DestroySurface(surface2);

    SDL_Surface* surface3 = IMG_Load("//Users/karen/Documents/Igboabuchukwu-chinaza-computer-graphics/SDL_Base_Project/pr1/girl.jpg");
